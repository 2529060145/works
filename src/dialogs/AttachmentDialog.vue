...
async function upload(){busy.value=true;try{if(await addAttachment(jobId.value)){ElMessage.success('附件已复制到程序目录的 data 文件夹');await load()}}catch(e){ElMessage.error(e instanceof Error?e.message:'添加附件失败')}finally{busy.value=false}}
